...
{
    private static IEnumerable<CodeQuality> TransformAllRaw(string sarifGlob, string roslynatorGlob, string? pathRoot, bool bumpToMajor)
    {
    ...
    {
        var cqrs = TransformAllRaw(sarifGlob, roslynatorGlob, pathRoot, bumpToMajor);
